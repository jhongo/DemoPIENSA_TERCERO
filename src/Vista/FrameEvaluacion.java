...
//        t = new Timer(10, acciones);
    ...
    private void initComponents() {
        ...
        Jpestudiantes.setBackground(new java.awt.Color(153, 255, 204));
        ...
        JPevaluacion.setBackground(new java.awt.Color(153, 255, 204));
        ...
        cmbsensibilidad.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "--SELECCIONE--", "BAJA", "MEDIA", "ALTA" }));

        cmbfuerzamuscular.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "--SELECCIONES--", "BAJA", "MEDIA", "ALTA" }));

        cmbcoordinacion.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "--SELECCIONE--", "BAJA", "MEDIA", "ALTA" }));
            ...
            .addGroup(JPevaluacionLayout.createSequentialGroup()
                ...
                .addGroup(JPevaluacionLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(JPevaluacionLayout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(JPevaluacionLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(cmbplaneacion, 0, 1, Short.MAX_VALUE)
                            .addComponent(cmbfuerzamuscular, 0, 1, Short.MAX_VALUE)
                            .addComponent(cmbsensibilidad, 0, 1, Short.MAX_VALUE)
                            .addComponent(cmbcoordinacion, 0, 1, Short.MAX_VALUE)
        ...
        btnevaluar.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED));
        ...
        jButton2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Vista/icons/save2.png"))); // NOI18N
        ...
        JPseleccionar.setBackground(new java.awt.Color(153, 255, 204));
        ...
        btnVolver.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Vista/icons/btn-cerrar.png"))); // NOI18N
        ...
        jpTiempo.setBackground(new java.awt.Color(102, 255, 255));
        jpTiempo.setBorder(javax.swing.BorderFactory.createEtchedBorder());

        jLabel18.setFont(new java.awt.Font("Dialog", 1, 11)); // NOI18N
        jLabel18.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Vista/icons/timeT.png"))); // NOI18N
        ...
        btnJuegoDetener.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Vista/icons/stp.png"))); // NOI18N
        ...
        jpTiempo1.setBackground(new java.awt.Color(102, 255, 255));
        jpTiempo1.setBorder(javax.swing.BorderFactory.createEtchedBorder());

        jLabel19.setFont(new java.awt.Font("Dialog", 1, 11)); // NOI18N
        jLabel19.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Vista/icons/wri.png"))); // NOI18N
        ...
        btnClean.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Vista/icons/clean.png"))); // NOI18N
        ...
        jLabel30.setText("Puntuación: 25 - 19 ALTA / 18 - 12 MEDIA / 11 - 0 BAJA");
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                .addGap(22, 22, 22)
                .addComponent(jLabel30, javax.swing.GroupLayout.PREFERRED_SIZE, 332, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        ...
        jLabel28.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Vista/icons/option.png"))); // NOI18N
        jLabel28.setText("OPCIONES");

        btnRegistrarEstudiantes.setFont(new java.awt.Font("Georgia", 1, 14)); // NOI18N
        btnRegistrarEstudiantes.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Vista/icons/addC.png"))); // NOI18N
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(btnRegistrarEstudiantes, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
        );
...
/*         FrameSeleccionar c = new FrameSeleccionar();
    ...
    private void btnGraficaEstadisticaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGraficaEstadisticaActionPerformed
        ...
        if (minutos < 1 && segundos <= 45 && milisegundos <=800) {
            try {
                DefaultCategoryDataset ds = new DefaultCategoryDataset();
                ds.addValue(20, "ALTA", "Coordinacion");
                ds.addValue(20, "ALTA", "Planeacion");
                ds.addValue(20, "ALTA", "Fuerza");
                ds.addValue(20, "ALTA", "Sensibiidad");
        ...
        } else if (minutos <= 1 && segundos <= 59 && milisegundos <=800){
            try {
                DefaultCategoryDataset ds = new DefaultCategoryDataset();
                ds.addValue(15, "MEDIA", "Coordinacion");
                ds.addValue(20, "ALTA", "Planeacion");
                ds.addValue(15, "MEDIA", "Fuerza");
        ...
        } else if (minutos >= 2 && segundos <=59 && milisegundos <=800) {
            try {
                DefaultCategoryDataset ds = new DefaultCategoryDataset();
                ds.addValue(10, "BAJA", "Coordinacion");
                ds.addValue(8, "BAJA", "Planeacion");
                ds.addValue(15, "MEDIA", "Fuerza");
                ds.addValue(12, "MEDIA", "Sensibiidad");
        ...
        }else if (minutos >=3 && segundos <=59 && milisegundos <=300) {
            try {
                DefaultCategoryDataset ds = new DefaultCategoryDataset();
                ds.addValue(5, "BAJA", "Coordinacion");
                ds.addValue(7, "BAJA", "Planeacion");
                ds.addValue(6, "BAJA", "Fuerza");
                ds.addValue(5, "BAJA", "Sensibiidad");
